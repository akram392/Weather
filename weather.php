...
$url = "https://api.openweathermap.org/data/2.5/forecast?q=$city&appid=b4329a46471da371c896e2e64afc3596&units=metric";
$c;
$apiData = file_get_contents($url);
$cli = json_decode($apiData);
 if($cli->list[0]->main->temp < 10){
     $sin = "./images/snowflake.jpg";
 }
 else if($cli->list[0]->main->temp > 20){
     $sin = "./images/green-field-with-cloud.jpg";
 }
 else{
     $sin = "./images/landscape.jpg";
 }
...
<head>
    ...
    <title>Weather Forcast- 5 Days</title>
    <link
